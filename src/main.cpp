...
bool engine_plays_white = true;//which side engine plays as, white by default
...
int main(){    
    ...
    if(engine_plays_white == true){
        ...
        array <Move, 100> depth1_moves;//making a copy of legal_moves array so that the actual array 
